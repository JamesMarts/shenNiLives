 ...
 * ========================================
 */
public class PlayerLiveActivity2 extends AutoLayoutActivity {
...
//            EventBus.getDefault().post(new RefreshMainEvent(true));
            Intent intent = new Intent(PlayerLiveActivity2.this, PlayerEndActivity.class);
            //int
...
//                return;
    ...
    protected void onRestart() {
        super.onRestart();
        monResume = 0;
        GoldPay.paySuccessAfter(PlayerLiveActivity2.this, SPUserUtils.sharedInstance().getUid());
    }
