...
//    private Subscription mSubscribe;
    ...
    private void initView() {
        View view = mInflater.inflate(R.layout.item_gifts, null);
        anim_rl = (RelativeLayout) view.findViewById(R.id.infoRl);
        anim_gift = (ImageView) view.findViewById(R.id.giftIv);
        anim_light = (ImageView) view.findViewById(R.id.tv_light);
        anim_num = (StrokeTextView) view.findViewById(R.id.animation_num);
        anim_header = (CircleImageView) view.findViewById(R.id.headIv);
    ...
    public AnimatorSet startAnimation() {
        ...
        flyFromLtoR.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                isEnd = false;
                try {
                    if (GiftStringUtils.isNullOrEmpty(mGift.getSendUserPic())) {
//                    if (mGift.getSendUserPic().equals("")) {
                        if (mGift.getSendUserPic().toLowerCase().endsWith(".gif")) {
                            Glide.with(mContext)
                                    .load(GiftStringUtils.getWebHeanPic())
                                    .asGif()
                                    .override(80, 80)
                                    .placeholder(R.drawable.icon_loadhean)
                                    .error(R.drawable.icon_loadhean)
                                    .dontAnimate()
                                    .centerCrop()
